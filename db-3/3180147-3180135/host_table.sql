...
AS (SELECT DISTINCT host_id as id, host_url as url, host_name as name, host_since as since,
	host_location as location, host_about as about, host_response_time as response_time,
	host_response_rate as response_rate, host_acceptance_rate as acceptance_rate, 
	host_is_superhost as is_superhost, host_thumbnail_url as thumbnail_url,
	host_picture_url as picture_url, host_neighbourhood as neighbourhood, 
	...
	host_identity_verified as identity_verified, calculated_host_listings_count FROM "Listings");
ALTER TABLE "Host"
ADD PRIMARY KEY (id);
